...
export function mapTautulliToPlexmo(
    ...
    const meta: any = {
        ...
        // Relation
        grandparentTitle: entry.grandparent_title,
        parentTitle: entry.parent_title,
    ...
    return {
        ...
        user: entry.user,
        title: entry.title || "Unknown Title", // Fallback for Partial<Metadata>
        ...
        pausedCounter: entry.paused_counter || 0 // seconds
    };
}
