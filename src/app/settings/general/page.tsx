...
import { Save, Globe, type LucideIcon } from "lucide-react";
        ...
        <div className="space-y-8">
            ...
            >
                <div className="grid gap-6">
                    {/* Language Card */}
                    <SettingsCard className="border-l-4 border-l-amber-500">
                        <div className="flex flex-col md:flex-row gap-6 md:items-start justify-between">
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-white/50">{t("settings.languageDesc")}</p>
                            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-between items-start">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-white/50 max-w-sm leading-relaxed">
                        Generate a secure key to allow third-party apps (like Rewrap) to access your data.
                    </p>
                </div>
