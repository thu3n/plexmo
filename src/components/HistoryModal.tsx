...
export function HistoryModal({ entry, onClose }: { entry: HistoryEntry; onClose: () => void }) {
    ...
    const startTimeResult = `${dateStr} ${timeStr}`;
            ...
            >
                ...
                <div className="group glass-panel rounded-3xl overflow-hidden flex flex-col w-full shadow-2xl border border-white/10 bg-[#0f1119] max-h-full relative">
                    ...
                    <div className="flex flex-col sm:flex-row flex-1 min-h-0 w-full relative">
                        ...
                        {/* Poster - Left Side */}
                        <div className="relative w-full sm:w-[40%] shrink-0 overflow-hidden border-b sm:border-b-0 sm:border-r border-white/5 h-48 sm:h-auto min-h-[200px] bg-black/20 group-hover:shadow-[0_0_40px_rgba(0,0,0,0.5)] z-0">
                            {details?.thumb ? (
                                <>
                                    <img
                            ...
                            {/* Platform Icon */}
                            <div className="absolute top-4 left-4 shadow-xl z-10">
                    ...
                    <div className="bg-black/40 p-4 sm:p-5 flex items-center justify-between border-t border-white/5 backdrop-blur-md">
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] bg-white/10 px-1.5 py-0.5 rounded text-white/40 uppercase font-bold tracking-wider">
